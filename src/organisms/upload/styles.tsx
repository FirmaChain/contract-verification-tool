...
export const Desc = styled.div<{ isDesktop?: boolean }>`
    ${(props) =>
        props.isDesktop
            ? `    
        font-size: 16px;
...
export const ErrorDesc = styled.div<{ isDesktop?: boolean }>`
    ${(props) =>
        props.isDesktop
            ? `    
        font-size: 26px;
...
export const LoadingTitle = styled.div<{ isDesktop?: boolean }>`
    ${(props) =>
        props.isDesktop
            ? `
        font-size: 32px;
...
export const Filename = styled.div<{ isDesktop?: boolean }>`
    ${(props) =>
        props.isDesktop
            ? `
        font-size: 20px;
...
export const Filesize = styled.div<{ isDesktop?: boolean }>`
    ${(props) =>
        props.isDesktop
            ? `
        font-size: 16px;
...
export const TabWrapper = styled.div<{ isDesktop?: boolean }>`
    border-radius: 50px;
...
export const UploadContainer = styled.div<{ isDesktop?: boolean }>`
    ${(props) =>
        props.isDesktop
            ? `
        width: 904px;
...
export const UploadFileWrapper = styled.div<{ enableToUpload?: boolean }>`
    width: 100%;
    margin: 24px 0 0;
    padding: 58px 0;
    border-radius: 8px;
